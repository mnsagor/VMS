                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.employees.update", [$employee->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('designation') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="designation" id="designation" value="{{ old('designation', $employee->designation) }}">
                        ...
                        <div class="form-group {{ $errors->has('phone_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $employee->phone_number) }}" required>
