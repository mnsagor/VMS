                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.drivers.update", [$driver->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('phone_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $driver->phone_number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="type" id="type">
                                ...
                                @foreach(App\Driver::TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('type', $driver->type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('type'))
                        ...
                        <div class="form-group {{ $errors->has('drivng_licence_validity') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="drivng_licence_validity" id="drivng_licence_validity" value="{{ old('drivng_licence_validity', $driver->drivng_licence_validity) }}" required>
