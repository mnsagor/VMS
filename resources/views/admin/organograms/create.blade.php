        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.organogram.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.organograms.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('post_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="post_name" id="post_name" value="{{ old('post_name', '') }}" required>
