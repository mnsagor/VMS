                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.vehicles.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('vehicle_serial') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="vehicle_serial" id="vehicle_serial" value="{{ old('vehicle_serial', 'BTCL_HQ_001') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('ragistration_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ragistration_number" id="ragistration_number" value="{{ old('ragistration_number', 'Dhaka Metro-GA 1234567') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('model_year') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="model_year" id="model_year" value="{{ old('model_year', '2005') }}">
                        ...
                        <div class="form-group {{ $errors->has('ragistration_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="ragistration_date" id="ragistration_date" value="{{ old('ragistration_date') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('engine_capacity') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="engine_capacity" id="engine_capacity" value="{{ old('engine_capacity', '1500 cc') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('fitness_vality') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="fitness_vality" id="fitness_vality" value="{{ old('fitness_vality') }}">
                        ...
                        <div class="form-group {{ $errors->has('tax_token_validity') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="tax_token_validity" id="tax_token_validity" value="{{ old('tax_token_validity') }}">
