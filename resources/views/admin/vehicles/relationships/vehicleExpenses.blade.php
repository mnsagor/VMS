            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-vehicleExpenses">
                            <thead>
                                <tr>
                                    <th width="10">
...
@endcan
  ...
  $('.datatable-vehicleExpenses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
