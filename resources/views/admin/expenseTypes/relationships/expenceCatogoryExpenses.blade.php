            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-expenceCatogoryExpenses">
                            <thead>
                                <tr>
                                    <th width="10">
                            ...
                            <tbody>
                                @foreach($expenses as $key => $expense)
                                    <tr data-entry-id="{{ $expense->id }}">
                                        ...
                                        <td>
                                            {{ $expense->vehicle->ragistration_number ?? '' }}
                                        </td>
                                        <td>
                                            {{ $expense->entry_date ?? '' }}
                                        </td>
...
@endcan
  ...
  $('.datatable-expenceCatogoryExpenses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
